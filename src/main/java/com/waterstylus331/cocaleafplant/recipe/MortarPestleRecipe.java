...
public class MortarPestleRecipe implements Recipe<SimpleContainer> {
    ...
    public MortarPestleRecipe(NonNullList<Ingredient> inputs, ItemStack out, ResourceLocation id) {
    ...
    public static class Serializer implements RecipeSerializer<MortarPestleRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(CocaLeafPlant.MODID, "mortar_and_pestle");

        @Override
        public MortarPestleRecipe fromJson(ResourceLocation location, JsonObject jsonObject) {
            ...
            return new MortarPestleRecipe(inputs, output, location);
        }

        @Override
        public @Nullable MortarPestleRecipe fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, MortarPestleRecipe mortarPestleRecipe) {
