...
public class MortarPestleMenu extends AbstractContainerMenu {
    ...
    public MortarPestleMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 38, 41));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 61, 41));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 125, 41));
        });
